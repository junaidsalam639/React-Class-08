...
export {auth , db , storage , signInWithEmailAndPassword , createUserWithEmailAndPassword , collection , addDoc , ref, uploadBytes , getDownloadURL , query, where, getDocs, onAuthStateChanged }
